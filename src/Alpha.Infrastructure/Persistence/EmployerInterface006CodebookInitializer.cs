...
public static class EmployerInterface006CodebookInitializer
{
    public static Task EnsureUpdatedAsync(AlphaDbContext db, CancellationToken ct = default) =>
        db.Database.ExecuteSqlRawAsync("""
            ...
            -- Legacy Alpha payment method choices are intentionally retired. The UI now uses
            -- KOD-EMTZAI-TASHLUM from Employer Interface 006 as the single payment-method source.
